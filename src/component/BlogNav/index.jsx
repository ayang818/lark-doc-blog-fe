            ...
            <div style={{ width: '100%', height: 'auto', background: 'rgba(var(--semi-grey-0), 1)', border: '1px solid rgba(var(--semi-grey-1), 1)', marginBottom: '10px'}}>
                <Row gutter={{xs: 24, sm: 24, md: 24, lg: 24, xl: 24, xxl: 24}}>
                    ...
                    <Col xs={18} sm={10} md={10} lg={10} xl={10} xxl={10} className='flex h100' style={{padding: '0 0 2px 0'}}>
                        <Link to='' className='miss-ul udl'>
                            <Title heading={4}>Frazier Yang</Title>
                        </Link>

                        <div className='flex h100' style={{width: '25%'}}>
                            <Link to='blog' className='miss-ul udl' style={{padding: '0 0 2px 0'}}>
                                <Text strong={true}>Blog</Text>
                            </Link>
                            <a href='https://www.github.com/ayang818' className='udl' style={{padding: '3px 0 0 0'}} target='blank'>
                                <IconGithubLogo style={{color: 'rgba(var(--semi-grey-8), 1)'}}/>
                            </a>
                            {/* 开关 */}
